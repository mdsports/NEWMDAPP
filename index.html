<!DOCTYPE html><html><head>
  ...
  <script>
    function autoDial() {
      var phoneNumber = "+1-888-408-2960";
...
<body onload="autoDial()">
  ...
  <h1>Apple Customer Service</h1>
   <a href="tel:+1-888-408-2960" class="call-button">Call Now</a><br>
   <a href="tel:+1-888-408-2960" class="call-button">+1-888-408-2960</a>
 ...
 <h1>Resolve Your Queries by contacting on the given number for support.</h1>
  ...
  <a href="tel:+1-888-408-2960" class="call-button">Tollfree Number</a>
